...
with DAG(
    ...
    @task
    def build_arguments_list(machines, topic, interval, partitions, replications):
    ...
    SMD_Producer_Realtime_Kafka = KubernetesPodOperator.partial(
        task_id="Producer_Realtime_Kafka",
        name="smd-producer-realtime-kafka",
        namespace="default",
        image="dwnusa/smd-producer:v0.1.2-amd64",
        cmds=[],
        in_cluster=True,
        get_logs=True,
    ...
    # 실행 순서: Realtime producer
    SMD_Producer_Realtime_Kafka